...
* add support for ! ([#441](https://github.com/Berkmann18/conventional-changelog/issues/441)) ([0887940](https://github.com/Berkmann18/conventional-changelog/commit/0887940e9103dca111e43337332913b37e1ee02a))
* add support for 'feature' as alias for 'feat' ([#582](https://github.com/Berkmann18/conventional-changelog/issues/582)) ([94c40f7](https://github.com/Berkmann18/conventional-changelog/commit/94c40f755e6c329311d89a47c634b91cf0276da3))
* add support for alphanumeric issues ([#1080](https://github.com/Berkmann18/conventional-changelog/issues/1080)) ([f9b1897](https://github.com/Berkmann18/conventional-changelog/commit/f9b18975ba1bf74ecb7a294f3b220794e0d09e0b))
* bang notes handling is removed ([#1355](https://github.com/Berkmann18/conventional-changelog/issues/1355)) ([5150f47](https://github.com/Berkmann18/conventional-changelog/commit/5150f479db0e633d5fab5853a68b6316134cd363))
* BREAKING CHANGES are important and should be prioritized ([#464](https://github.com/Berkmann18/conventional-changelog/issues/464)) ([f8adba2](https://github.com/Berkmann18/conventional-changelog/commit/f8adba2f7dc84fd73adafb695371e0624b922792))
...
* creating highly configurable preset, based on conventionalcommits.org ([#421](https://github.com/Berkmann18/conventional-changelog/issues/421)) ([f2fb240](https://github.com/Berkmann18/conventional-changelog/commit/f2fb240391e10c79756a590eb6aea1e235ccb0a2))
...
* scope option can be an array of strings ([#1391](https://github.com/Berkmann18/conventional-changelog/issues/1391)) ([81da809](https://github.com/Berkmann18/conventional-changelog/commit/81da80996888efb0277f7c6f76f2dd39164d81bd))
* scope, scopeOnly and bumpStrict options were added ([e2973e2](https://github.com/Berkmann18/conventional-changelog/commit/e2973e28380405bfa62396ad0638ffc7cc237e0d))
* sort groups based on config types ([#702](https://github.com/Berkmann18/conventional-changelog/issues/702)) ([#1002](https://github.com/Berkmann18/conventional-changelog/issues/1002)) ([0e59f0c](https://github.com/Berkmann18/conventional-changelog/commit/0e59f0c884bf104e3a6a14c5669c58755cdef064))
* sort sections of CHANGELOG based on priority ([#513](https://github.com/Berkmann18/conventional-changelog/issues/513)) ([a3acc32](https://github.com/Berkmann18/conventional-changelog/commit/a3acc3222135b17af0ee9785605d21b104ed0aef))
...
* add add-bang-notes to files list ([7e4e4d2](https://github.com/Berkmann18/conventional-changelog/commit/7e4e4d2ef38537f55926aa1d91eb482d574609c1))
* address discrepancies between cc preset and spec ([#429](https://github.com/Berkmann18/conventional-changelog/issues/429)) ([18f71d2](https://github.com/Berkmann18/conventional-changelog/commit/18f71d228c9676af13b736cb46614f23b66e796e))
* adhere to config spec ([#432](https://github.com/Berkmann18/conventional-changelog/issues/432)) ([4eb1f55](https://github.com/Berkmann18/conventional-changelog/commit/4eb1f558d6b855e0caf66cc294407e6ab2527d75))
* always use H2 heading for versions ([#920](https://github.com/Berkmann18/conventional-changelog/issues/920)) ([d2e02d7](https://github.com/Berkmann18/conventional-changelog/commit/d2e02d73f275bd10a39c52016999d8faf400c990)), closes [#867](https://github.com/Berkmann18/conventional-changelog/issues/867)
* avoid double empty lines ([#1235](https://github.com/Berkmann18/conventional-changelog/issues/1235)) ([3b4bfdf](https://github.com/Berkmann18/conventional-changelog/commit/3b4bfdf3ac7d26da8466a577227254123b767336)), closes [#1188](https://github.com/Berkmann18/conventional-changelog/issues/1188)
* don't require 'host' and 'repository' when deciding whether to render URLs ([#447](https://github.com/Berkmann18/conventional-changelog/issues/447)) ([83dff7a](https://github.com/Berkmann18/conventional-changelog/commit/83dff7aff782a2a24685f1a0b9c42ffb98ec6a3e))
* don't use multiple H1 tags ([#440](https://github.com/Berkmann18/conventional-changelog/issues/440)) ([3d79263](https://github.com/Berkmann18/conventional-changelog/commit/3d792639815e4c4ae7758e0e84ba72a9cb535f37))
* Downgrade node 10.x dependency to 6.9.0 dependency ([#437](https://github.com/Berkmann18/conventional-changelog/issues/437)) ([ded5a30](https://github.com/Berkmann18/conventional-changelog/commit/ded5a304cd0b53100f94fff6b225c7178f5eb449))
* fix handling input params ([#1120](https://github.com/Berkmann18/conventional-changelog/issues/1120)) ([e721cde](https://github.com/Berkmann18/conventional-changelog/commit/e721cdec8de32162dd56096ef6a07786f1b4faec))
* if ! and BREAKING CHANGE were used, notes would populate twice ([#446](https://github.com/Berkmann18/conventional-changelog/issues/446)) ([63d8cbe](https://github.com/Berkmann18/conventional-changelog/commit/63d8cbedd24d957c759865211dd2341fd4a3e1f2))
* include constants.js in package ([#1095](https://github.com/Berkmann18/conventional-changelog/issues/1095)) ([a730b18](https://github.com/Berkmann18/conventional-changelog/commit/a730b186c10493ee551b84b528d7437dbc3feac0)), closes [#1093](https://github.com/Berkmann18/conventional-changelog/issues/1093)
* pass config to parserOpts and writerOpts ([73c7a1b](https://github.com/Berkmann18/conventional-changelog/commit/73c7a1b92c2a47c498f42972acbffa156172a341))
