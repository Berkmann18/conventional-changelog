...
* add execOpts.cwd ([2631213](https://github.com/Berkmann18/conventional-changelog/commit/263121376323babeb5bd0e8e48b852921ff81d81))
* add support for multiple paths ([#1079](https://github.com/Berkmann18/conventional-changelog/issues/1079)) ([107daf2](https://github.com/Berkmann18/conventional-changelog/commit/107daf24368b07301e1fd6611a8e7c3d7d7cd637))
* allow raw commits to be filtered by path ([#172](https://github.com/Berkmann18/conventional-changelog/issues/172)) ([ec0a25d](https://github.com/Berkmann18/conventional-changelog/commit/ec0a25d0664ae74da1201c011814f62bd8e1b031))
...
* ignore commits by regex ([#1063](https://github.com/Berkmann18/conventional-changelog/issues/1063)) ([47033e6](https://github.com/Berkmann18/conventional-changelog/commit/47033e6edfea3705383bb075bc6a4bd417f9ed8c))
...
* refactored to use @conventional-changelog/git-client ([#1199](https://github.com/Berkmann18/conventional-changelog/issues/1199)) ([ba03ffc](https://github.com/Berkmann18/conventional-changelog/commit/ba03ffc3c05e794db48b18a508f296d4d662a5d9))
* rewrite this module ([8968f1b](https://github.com/Berkmann18/conventional-changelog/commit/8968f1b6e88ecf4131d6223ccde1e3faef7d192d))
...
* allow raw commits to be filtered by path and date range ([#893](https://github.com/Berkmann18/conventional-changelog/issues/893)) ([b2245a7](https://github.com/Berkmann18/conventional-changelog/commit/b2245a766c70d280380abbbe85c4894eee04fdd0))
...
* normalize git show signature option to false ([#671](https://github.com/Berkmann18/conventional-changelog/issues/671)) ([a0b348c](https://github.com/Berkmann18/conventional-changelog/commit/a0b348c7a74ba49bb07053ed1d25c2053a7c3b1a)), closes [conventional-changelog/commitlint#2118](https://github.com/conventional-changelog/commitlint/issues/2118)
* revert normalize git show signature option to false ([c4d9042](https://github.com/Berkmann18/conventional-changelog/commit/c4d9042ae83aa2c823dca181dd72e5a8b3163c1e))
* update dependency dargs to v8 ([#1028](https://github.com/Berkmann18/conventional-changelog/issues/1028)) ([1dbcc99](https://github.com/Berkmann18/conventional-changelog/commit/1dbcc993ba0352b140fcf7074c1ee4078298ea5f))
...
* feat(maxBuffer): expose this option incase of long git history ([2572611](https://github.com/Berkmann18/conventional-changelog/commit/2572611f032c74135695b946f8eb844570039dc8))
...
* init ([ae118df](https://github.com/Berkmann18/conventional-changelog/commit/ae118df3fbc037664cf4212ce07efd4265dd62c4))
